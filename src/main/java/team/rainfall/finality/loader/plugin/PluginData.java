...
/**
 * <p>The PluginData class represents the data of a plugin, including its JAR file and manifest.</p>
 * <p>It is responsible for loading the plugin's JAR file and manifest from the specified file.</p>
 *
 * @author RedreamR
 */
public class PluginData {
    ...
    /**
     * <p>Constructs a PluginData object with the specified file.</p>
     * <p>Loads the JAR file and manifest if the file is a valid JAR file.</p>
     *
